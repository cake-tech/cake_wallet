...
import 'default_tron_tokens.dart';
import 'tron_client.dart';
import 'tron_transaction_history.dart';
import 'tron_transaction_info.dart';

class TronWallet extends EVMChainWallet {
  TronWallet({
  ...
  Future<void> initErc20TokensBox() async {
    final boxName = "${walletInfo.name.replaceAll(" ", "_")}_ ${Erc20Token.tronBoxName}";
  ...
  void addInitialTokens() {
    final initialErc20Tokens = DefaultTronTokens().initialTronTokens;
