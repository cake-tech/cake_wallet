      ...
      : hasSellAction = false,
        ...
        filterItems = {
          ...
          S.current.trades: [
            ...
            FilterItem(
                value: () => tradeFilterStore.displayMayaChain,
                caption: ExchangeProviderDescription.mayaChain.title,
                onChanged: () =>
                    tradeFilterStore.toggleDisplayExchange(ExchangeProviderDescription.mayaChain)),
            FilterItem(
