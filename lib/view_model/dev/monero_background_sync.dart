...
abstract class DevMoneroBackgroundSyncBase with Store {
  ...
  Future<void> _setValues() async {
    ...
    seed = wallet.seed;
    seedLegacy = monero!.getLegacySeed(wallet, "English");
  ...
  void startBackgroundSync() {
    unawaited(monero!.startBackgroundSync(wallet));
  }

  @action
  Future<void> stopBackgroundSync() async {
    final keyService = getIt.get<KeyService>();
    final password = await keyService.getWalletPassword(walletName: wallet.name);
