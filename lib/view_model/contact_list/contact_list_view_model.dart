...
abstract class ContactListViewModelBase with Store {
    ...
    walletInfoSource.values.forEach((info) {
      ...
      if (isAutoGenerateEnabled && info.type == WalletType.monero && info.addressInfos != null) {
        info.addressInfos!.forEach((key, value) {
          ...
          final name = _createAutoGeneratedName(
              info.name, nextUnusedAddress.label, nextUnusedAddress.address);
  ...
  String _createAutoGeneratedName(String walletName, String label, String address) {
    if (label.isNotEmpty) {
      return '$walletName ($label)';
    }
