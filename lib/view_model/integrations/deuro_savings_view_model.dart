...
part 'deuro_savings_view_model.g.dart';

class DEuroSavingsViewModel = DEuroSavingsViewModelBase with _$DEuroSavingsViewModel;

abstract class DEuroSavingsViewModelBase with Store {
  final AppStore _appStore;

  static BigInt get MIN_ACCRUED_INTEREST => BigInt.parse("1000000000000");

  DEuroSavingsViewModelBase(
    this._appStore,
