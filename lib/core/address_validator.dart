  ...
  static String getPattern(CryptoCurrency type) {
    ...
    switch (type) {
      ...
      case CryptoCurrency.btc:
        pattern =
            '${P2pkhAddress.regex.pattern}|${P2shAddress.regex.pattern}|${RegExp(r'(bc|tb)1q[ac-hj-np-z02-9]{25,39}}')}|${P2trAddress.regex.pattern}|${P2wshAddress.regex.pattern}|${SilentPaymentAddress.regex.pattern}';
      case CryptoCurrency.ltc:
        pattern = '^${RegExp(r'ltc1q[ac-hj-np-z02-9]{25,39}')}\$|^${MwebAddress.regex.pattern}\$';
