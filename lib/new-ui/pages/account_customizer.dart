...
class _AccountCustomizerState extends State<AccountCustomizer> {
                  ...
                  ReorderableListView.builder(
                    ...
                    onReorder: (int oldIndex, int newIndex) {
                      setState(() {
                        ...
                        final int index = _cardOrder.removeAt(oldIndex);
                        _cards.insert(newIndex, item);
                        _cardOrder.insert(newIndex, index);
                      });
                    },
  ...
  Future<void> saveCardOrder() async {
    ...
    for(int i=0; i<_cards.length; i++) {
      await BalanceCardStyleSettings.fromCardDesign(widget.dashboardViewModel.wallet.walletInfo.internalId, _cardOrder[i], i, _cards[i].design).insert();
    }
  }
}
