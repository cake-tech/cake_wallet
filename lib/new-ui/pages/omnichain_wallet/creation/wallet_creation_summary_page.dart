...
import "package:cake_wallet/new-ui/widgets/image_widgets/confetti_burst_widget.dart";
import "package:cake_wallet/new-ui/widgets/image_widgets/overlapping_icon_stack_rows_widget.dart";
...
class WalletCreationSuccessPageBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) => BlocConsumer<OmniChainWalletBloc, WalletCreationState>(
    ...
    builder: (context, state) {
      ...
      final (walletName, selectedTypes, walletIcon) = switch (state) {
        WalletCreationSummary(:final groupName, :final selectedTypes, :final walletIcon) ||
        WalletCreationOpeningNetwork(:final groupName, :final selectedTypes, :final walletIcon) ||
        WalletCreationSeedBackup(:final groupName, :final selectedTypes, :final walletIcon) =>
        (
        groupName,
      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: WalletIconAvatar(icon: walletIcon),
            ),
            const SizedBox(height: 28),
            Text(
              displayName,
