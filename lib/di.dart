...
Future<void> setup({
  ...
  getIt.registerFactoryParam<BuySellPage, BuySellPageParams?, void>((params, _) => BuySellPage(getIt.get<BuySellViewModel>(), getIt.get<AddressResolverService>(), params: params,));
