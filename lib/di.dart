...
Future<void> setup({
  ...
  getIt.registerFactory(() => DisplaySettingsViewModel(getIt.get<SettingsStore>()));
  ...
  getIt.registerFactory(() => SecuritySettingsViewModel(getIt.get<SettingsStore>()));
  ...
  getIt.registerFactoryParam<WalletRestoreViewModel, WalletType, RestoredWallet?>(
      (WalletType type, restoredWallet) => WalletRestoreViewModel(
          getIt.get<AppStore>(),
          getIt.get<WalletCreationService>(param1: type),
          _walletInfoSource,
          getIt.get<SeedSettingsViewModel>(),
  ...
  getIt.registerFactoryParam<WalletRestorePage, WalletType, RestoredWallet?>(
      (WalletType type, restoredWallet) {
  ...
  getIt.registerFactory(() => SupportViewModel(getIt.get<SettingsStore>(), getIt.get<AppStore>()));
