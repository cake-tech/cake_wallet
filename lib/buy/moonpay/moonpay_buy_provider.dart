...
class MoonPaySellProvider {
  ...
  Future<void> launchProvider(BuildContext context,
      {required WalletBase wallet, required SettingsStore settingsStore}) async {
    ...
    if (DeviceInfo.instance.isMobile) {
      Navigator.of(context).pushNamed(Routes.webViewPage, arguments: [S.of(context).sell, uri]);
    } else {
      await launchUrl(uri);
    }
  }
