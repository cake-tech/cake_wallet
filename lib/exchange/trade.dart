...
class Trade {
  ...
  static final StreamController<void> onChanged =
  ...
  Map<String, dynamic> toSqliteMap() {
    return <String, dynamic>{
      ...
      'requiresTokenApproval':
          requiresTokenApproval == true ? 1 : 0,
      'chainId': chainId,
      'fee': fee,
    };
  }
  ...
  factory Trade.fromSqliteRow(Map<String, dynamic> row) {
    final trade = Trade(
      ...
      outputTransaction:
          row['outputTransaction'] as String?,
      ...
      fromWalletAddress:
          row['fromWalletAddress'] as String?,
      ...
      sourceTokenAddress:
          row['sourceTokenAddress'] as String?,
      sourceTokenDecimals:
          row['sourceTokenDecimals'] as int?,
      ...
      sourceTokenAmountRaw:
          row['sourceTokenAmountRaw'] as String?,
      requiresTokenApproval:
          (row['requiresTokenApproval'] as int?) == 1,
