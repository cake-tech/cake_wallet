...
class CWHavenSubaddressList extends MoneroSubaddressList {
  ...
  void update(Object wallet, {required int accountIndex}) {
    final havenWallet = wallet as HavenWallet;
    havenWallet.walletAddresses.subaddressList
  ...
  Future<void> setLabelSubaddress(Object wallet,
    ...
    final havenWallet = wallet as HavenWallet;
    await havenWallet.walletAddresses.subaddressList.setLabelSubaddress(
...
class CWHaven extends Haven {
  ...
  int getHeightByDate({required DateTime date}) =>
      getHavenHeightByDate(date: date);
  ...
  void setCurrentAccount(Object wallet, int id, String label) {
    final havenWallet = wallet as HavenWallet;
    havenWallet.walletAddresses.account =
  ...
  Future<void> backupHavenSeeds(Box<HavenSeedStore> havenSeedStore) async {
    ...
    for (var w in wallets) {
      ...
      await havenSeedStore
          .add(HavenSeedStore(id: wallet.id, seed: wallet.seed));
      wallet.close();
    }
  ...
  @override
  List<AssetRate> getAssetRate() => getRate()
