...
class AddressTextField<T extends Currency> extends StatelessWidget {
  ...
  /// `bitcoin:bc1q...?amount=0.001&pj=https://...`,
  /// `monero:44AFF...?amount=1` or `ethereum:0x...?value=1`. A bare address
  /// never has both a scheme separator and a query string.
  ...
  /// Sets the visible field text to the bare address and dispatches the
