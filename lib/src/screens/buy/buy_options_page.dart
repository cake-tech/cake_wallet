...
class BuyOptionsPage extends BasePage {
  ...
  Widget body(BuildContext context) {
    ...
    final iconRobinhood =
    Image.asset(
        isLightMode ? iconLightRobinhood : iconDarkRobinhood, height: 40,
        width: 40);
    final iconOnramper =
    Image.asset(isLightMode ? iconLightOnramper : iconDarkOnramper, height: 40,
        width: 40);
            ...
            children: [
              ...
              Padding(
                ...
                child: OptionTile(
                  ...
                  onPressed: () async =>
                  await getIt.get<OnRamperBuyProvider>().launchProvider(
                      context),
                ),
              ),
              ...
              Padding(
                ...
                child: OptionTile(
                  ...
                  onPressed: () async =>
                  await getIt.get<RobinhoodBuyProvider>().launchProvider(
                      context),
                ),
              ),
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: Theme.of(context).extension<TransactionTradeTheme>()!
                        .detailsTitlesColor,
                  ),
                ),
              ),
