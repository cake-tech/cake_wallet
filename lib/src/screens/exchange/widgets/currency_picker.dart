...
class CurrencyPicker extends StatefulWidget {
  ...
  CurrencyPickerState createState() =>
      CurrencyPickerState(selectedAtIndex, items, title, onItemSelected);
}

class CurrencyPickerState extends State<CurrencyPicker> {
  CurrencyPickerState(
      this.selectedAtIndex, this.items, this.title, this.onItemSelected)
                        ...
                        children: <Widget>[
                          GridView.count(
                              ...
                              children: List.generate(
                                  itemsCount +
                                      getExtraEmptyTilesCount(
                                          crossAxisCount, itemsCount), (index) {
                                if (index >= itemsCount) {
                                  return Container(
                                    color: Theme.of(context)
                                        .accentTextTheme
