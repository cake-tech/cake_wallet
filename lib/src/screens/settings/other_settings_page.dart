      ...
      content: NewListSections(sections: {
        ...
        "dev": FeatureFlag.hasDevOptions == false
            ...
            : [
                ...
                ListItemRegularRow(
                  keyValue: '[dev] file explorer',
                  label: '[dev] file explorer',
                  onTap: () => Navigator.of(context).pushNamed(Routes.devFileExplorer),
                ),
                ListItemRegularRow(
                  keyValue: '[dev] wallet fuzzer',
                  label: '[dev] wallet fuzzer',
                  onTap: () => Navigator.of(context).pushNamed(Routes.devWalletFuzzer),
                ),
                ListItemRegularRow(
