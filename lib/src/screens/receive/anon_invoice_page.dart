...
class AnonPayInvoicePage extends BasePage {
  ...
  CryptoCurrency _selectedCurrency = CryptoCurrency.xmr;
              ...
              builder: (_) => Container(
                ...
                child: Padding(
                    ...
                    children: <Widget>[
                      Container(
                        decoration: BoxDecoration(
                          border: Border(bottom: BorderSide(color:  Theme.of(context).accentTextTheme.headline6!.backgroundColor!, width: 1)),
                        ),
                        child: Observer(
                          builder: (_) => Padding(
  ...
  void _presentPicker(BuildContext context) {
    showPopUp<void>(
      builder: (_) => CurrencyPicker(
          ...
          isConvertFrom: false,
          onItemSelected: (CryptoCurrency item) => null),
      context: context,
    );
  }
}
