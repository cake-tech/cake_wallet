...
class Erc20Decoder {
  ...
  Future<WCDecodedRequest?> _decodeApprove(
    ...
    if (spender == null || rawAmount == null || contractAddress == null) return null;
    ...
    final isUnlimited = calldata.isUnlimited(rawAmount);
  ...
  Future<WCDecodedRequest?> _decodeTransfer(
    ...
    final rawAmount = calldata.uintAt(1);
    if (recipient == null || rawAmount == null || contractAddress == null) return null;
  ...
  Future<WCDecodedRequest?> _decodeAllowanceDelta(
    ...
    if (spender == null || delta == null || contractAddress == null) return null;
  ...
  Future<WCDecodedRequest?> _decodeWethUnwrap(
    ...
    final amountStr = tokenResolver.formatNative(native);
