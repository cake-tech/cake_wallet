...
class _WalletRestorePageBodyState extends State<_WalletRestorePageBody>
  ...
  bool _isValidSeed() {
    ...
    if ([WalletType.monero, WalletType.wownero, WalletType.nerva, WalletType.haven]
    ...
    final nonBip39WalletTypes = [WalletType.wownero, WalletType.nerva, WalletType.haven, WalletType.decred];
