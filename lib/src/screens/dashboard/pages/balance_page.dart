  ...
  Widget build(BuildContext context) {
    return Column(children: [
      Container(
        ...
        child: Container(
          margin:
              const EdgeInsets.only(top: 16, left: 24, right: 8, bottom: 16),
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              GestureDetector(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          onTap: hasAdditionalBalance
                              ? () => _showBalanceDescription(context,
                                  S.of(context).available_balance_description)
                              : null,
                          child: Row(
                            children: [
                              Semantics(
              ...
              if (frozenBalance.isNotEmpty)
                GestureDetector(
                  ...
                  onTap: hasAdditionalBalance
                      ? () => _showBalanceDescription(context,
                          S.of(context).unavailable_balance_description)
                      : null,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
              ...
              children: [
                Container(
                  margin: const EdgeInsets.only(
                      top: 16, left: 24, right: 8, bottom: 16),
                  child: Stack(
                    children: [
                      ...
                      if (hasSecondAvailableBalance)
                        GestureDetector(
                          onTap: () => dashboardViewModel.balanceViewModel
                              .switchBalanceValue(),
                          child: Row(
                            children: [
                              Column(
                ...
                Container(
                  margin: const EdgeInsets.only(
                      top: 0, left: 24, right: 8, bottom: 16),
                  child: Stack(
                    children: [
                            ...
                            child: OutlinedButton(
                              onPressed: () {
                                final mwebAddress = bitcoin!
                                    .getUnusedMwebAddress(
                                        dashboardViewModel.wallet);
                              ...
                              style: OutlinedButton.styleFrom(
                                backgroundColor:
                                    Colors.grey.shade400.withAlpha(50),
                                side: BorderSide(
