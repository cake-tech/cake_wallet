...
class _DesktopWalletSelectionDropDownState extends State<DesktopWalletSelectionDropDown> {
  ...
  final baseIcon = Image.asset('assets/images/base_icon.png', height: 24, width: 24);
  ...
  final dogeIcon = Image.asset('assets/images/crypto/dogecoin.png', height: 24, width: 24);
