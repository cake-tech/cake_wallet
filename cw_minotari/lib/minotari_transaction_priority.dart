...
class MinotariTransactionPriority extends TransactionPriority {
  ...
  static const List<MinotariTransactionPriority> all = [fast, medium, slow];
  ...
  static MinotariTransactionPriority deserialize({required int raw}) {
    switch (raw) {
      ...
      default:
        throw Exception(
            'Unexpected token: $raw for MinotariTransactionPriority deserialize');
    }
  }
  ...
  String labelWithRate(int feePerGram) =>
      '${toString()} ($feePerGram $units/g)';
}
