...
class FiatCurrency extends EnumerableItem<String> with Serializable<String> implements Currency {
  ...
  static const clp =
      FiatCurrency(symbol: "CLP", countryCode: "chl", fullName: "Chilean Peso", decimals: 0);
  ...
  static const isk =
      FiatCurrency(symbol: "ISK", countryCode: "isl", fullName: "Icelandic Króna", decimals: 0);
  static const jpy =
      FiatCurrency(symbol: "JPY", countryCode: "jpn", fullName: "Japanese Yen", decimals: 0);
  static const kes = FiatCurrency(symbol: "KES", countryCode: "ken", fullName: "Kenyan Shilling");
  static const krw =
      FiatCurrency(symbol: "KRW", countryCode: "kor", fullName: "South Korean Won", decimals: 0);
  ...
  static const pln = FiatCurrency(symbol: "PLN", countryCode: "pol", fullName: "Polish Złoty");
  ...
  static const twd = FiatCurrency(symbol: "TWD", countryCode: "twn", fullName: "New Taiwan Dollar");
  ...
  static const ves =
      FiatCurrency(symbol: "VES", countryCode: "ven", fullName: "Venezuelan Bolívar");
  static const vnd =
      FiatCurrency(symbol: "VND", countryCode: "vnm", fullName: "Vietnamese Đồng", decimals: 0);
  static const zar =
