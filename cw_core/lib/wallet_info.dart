...
class WalletInfo {
  ...
  Future<int> save() async {
    ...
    internalId = await db.transaction((txn) async {
      return await txn.insert(tableName, json, conflictAlgorithm: ConflictAlgorithm.replace);
    });
    return internalId;
  }
  ...
  static Future<List<WalletInfo>> selectList(String where, List<dynamic> whereArgs, {String orderBy= 'sortOrder ASC'}) async {
