...
Future<String> generateName() async {
  ...
  final adjectiveStringRaw = await rootBundle.loadString("assets/text/Wallet_Adjectives.txt");
  final nounStringRaw = await rootBundle.loadString("assets/text/Wallet_Nouns.txt");
