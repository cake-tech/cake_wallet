...
class CryptoCurrency extends EnumerableItem<int> with Serializable<int> implements Currency {
  ...
  static const xmr = CryptoCurrency(
      ...
      raw: 0,
      name: 'xmr',
      iconPath: 'assets/images/monero_icon.png',
      decimals: 12);
  ...
  static const bch = CryptoCurrency(
      ...
      raw: 2,
      name: 'bch',
      iconPath: 'assets/images/bch_icon.png',
      decimals: 8);
  ...
  static const dai = CryptoCurrency(
      ...
      raw: 5,
      name: 'dai',
      iconPath: 'assets/images/dai_icon.png',
      decimals: 18);
  ...
  static const ltc = CryptoCurrency(
      ...
      raw: 9,
      name: 'ltc',
      iconPath: 'assets/images/litecoin-ltc_icon.png',
      decimals: 8);
  ...
  static const trx = CryptoCurrency(
      ...
      raw: 11,
      name: 'trx',
      iconPath: 'assets/images/trx_icon.png',
      decimals: 6);
  ...
  static const usdterc20 = CryptoCurrency(
      ...
      raw: 13,
      name: 'usdterc20',
      iconPath: 'assets/images/usdterc20_icon.png',
      decimals: 6);
  ...
  static const doge = CryptoCurrency(
      ...
      raw: 34,
      name: 'doge',
      iconPath: 'assets/images/doge_icon.png',
      decimals: 8);
  ...
  static const usdttrc20 = CryptoCurrency(
      ...
      raw: 36,
      name: 'usdttrc20',
      iconPath: 'assets/images/usdttrc20_icon.png',
      decimals: 6);
  ...
  static const usdc = CryptoCurrency(
      ...
      raw: 40,
      name: 'usdc',
      iconPath: 'assets/images/usdc_icon.png',
      decimals: 6);
  ...
  static const dcr = CryptoCurrency(
      ...
      raw: 47,
      name: 'dcr',
      iconPath: 'assets/images/dcr_icon.png',
      decimals: 8);
  ...
  static const maticpoly = CryptoCurrency(
      ...
      raw: 50,
      name: 'maticpoly',
      iconPath: 'assets/images/matic_icon.png',
      decimals: 18);
  ...
  static const paxg = CryptoCurrency(
      ...
      raw: 55,
      name: 'paxg',
      iconPath: 'assets/images/paxg_icon.png',
      decimals: 18);
  ...
  static const arb = CryptoCurrency(
      ...
      raw: 65,
      name: 'arb',
      iconPath: 'assets/images/arb_icon.png',
      decimals: 18);
  ...
  static const wbtc = CryptoCurrency(
      ...
      raw: 81,
      name: 'wbtc',
      iconPath: 'assets/images/wbtc_icon.png',
      decimals: 8);
  static const weth = CryptoCurrency(
      ...
      raw: 82,
      name: 'weth',
      iconPath: 'assets/images/weth_icon.png',
      decimals: 18);
  ...
  static const steth = CryptoCurrency(
      ...
      raw: 85,
      name: 'steth',
      iconPath: 'assets/images/steth_icon.png',
      decimals: 18);
  ...
  static final Map<int, CryptoCurrency> _rawCurrencyMap = [...all, ...havenCurrencies]
      .fold<Map<int, CryptoCurrency>>(<int, CryptoCurrency>{}, (acc, item) {
    acc.addAll({item.raw: item});
    return acc;
  });

  static final Map<String, CryptoCurrency> _nameCurrencyMap = [...all, ...havenCurrencies]
      .fold<Map<String, CryptoCurrency>>(<String, CryptoCurrency>{}, (acc, item) {
    acc.addAll({item.name: item});
    return acc;
  });

  static final Map<String, CryptoCurrency> _fullNameCurrencyMap = [...all, ...havenCurrencies]
      .fold<Map<String, CryptoCurrency>>(<String, CryptoCurrency>{}, (acc, item) {
