...
part 'nerva_subaddress_list.g.dart';

class NervaSubaddressList = NervaSubaddressListBase with _$NervaSubaddressList;

abstract class NervaSubaddressListBase with Store {
  NervaSubaddressListBase()
      : _isRefreshing = false,
        _isUpdating = false,
