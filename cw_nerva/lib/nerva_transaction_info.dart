...
class NervaTransactionInfo extends TransactionInfo {
  NervaTransactionInfo(this.txHash, this.height, this.direction, this.date,
      this.isPending, this.amount, this.accountIndex, this.addressIndex, this.fee,
      this.confirmations) :
      id = "${txHash}_${amount}_${accountIndex}_${addressIndex}";

  NervaTransactionInfo.fromMap(Map<String, Object?> map)
  ...
  @override
  String amountFormatted() => '${formatAmount(nervaAmountToString(amount: amount))} XNV';
  ...
  @override
  String feeFormatted() => '${formatAmount(nervaAmountToString(amount: fee))} XNV';
}
