...
SALVIUM_SRC_DIR=${WORKDIR}/salvium

git clone https://github.com/salvium/salvium.git ${SALVIUM_SRC_DIR}
cd $SALVIUM_SRC_DIR
...
DEST_LIB_DIR=${PREFIX}/lib/salvium
DEST_INCLUDE_DIR=${PREFIX}/include/salvium
