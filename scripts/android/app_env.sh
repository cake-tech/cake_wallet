...
TYPES=($MONERO_COM $CAKEWALLET $HAVEN $SALVIUM)
APP_ANDROID_TYPE=$1
...
SALVIUM_NAME="Salvium"
SALVIUM_VERSION="0.6.4"
SALVIUM_BUILD_NUMBER=1
SALVIUM_BUNDLE_ID="com.cakewallet.salvium"
SALVIUM_PACKAGE="com.cakewallet.salvium"
...
case $APP_ANDROID_TYPE in
	...
	$HAVEN)
		...
		;;
	$SALVIUM)
		APP_ANDROID_NAME=$SALVIUM_NAME
		APP_ANDROID_VERSION=$SALVIUM_VERSION
		APP_ANDROID_BUILD_NUMBER=$SALVIUM_BUILD_NUMBER
		APP_ANDROID_BUNDLE_ID=$SALVIUM_BUNDLE_ID
		APP_ANDROID_PACKAGE=$SALVIUM_PACKAGE
		;;
esac
