...
if [[ ! "x$USE_DOCKER" == "x" ]];
then
    for COIN in monero wownero nerva;
    do
        pushd ../monero_c
            echo "unsupported!"
            exit 1
    ...
    do
        ...
        NERVA_LIBS="$NERVA_LIBS -arch ${ARCH} ${MONEROC_RELEASE_DIR}/${HOST}/libnerva_wallet2_api_c.dylib"
        pushd ../monero_c
...
lipo -create ${NERVA_LIBS} -output "${MONEROC_RELEASE_DIR}/../../../../macos/libnerva_wallet2_api_c.dylib"
