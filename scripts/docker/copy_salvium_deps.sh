...
CW_SALVIUM_EXTERNAL_DIR=${CW_DIR}/cw_salvium/ios/External/android
...
mkdir -p ${CW_SALVIUM_EXTERNAL_DIR}/include
...
cp $CW_EXRTERNAL_DIR/x86/include/salvium/wallet2_api.h ${CW_SALVIUM_EXTERNAL_DIR}/include
