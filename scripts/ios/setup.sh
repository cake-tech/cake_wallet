...
libtool -static -o libsalvium.a ./salvium/*.a
...
CW_SALVIUM_EXTERNAL_LIB=../../../../../cw_salvium/ios/External/ios/lib
CW_SALVIUM_EXTERNAL_INCLUDE=../../../../../cw_salvium/ios/External/ios/include
