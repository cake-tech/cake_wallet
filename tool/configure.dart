...
abstract class Pivx {
  ...
  /// contract, so node switching won't move a PIVX wallet onto a node that
  /// can't do shielded sync.
  Future<bool> checkNodeSupportsSapling(
      {required Uri uri, bool? useSSL, required bool isTestnet});
}
""";
