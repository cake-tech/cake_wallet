...
class SecretKey {
  ...
  static final base = [
    ...
    SecretKey('zanoTestWalletSeeds', () => ''),
    SecretKey('decredTestWalletSeeds', () => ''),
    SecretKey('dogeTestWalletSeeds', () => ''),
    SecretKey('zcashTestWalletSeeds', () => ''),
    ...
    SecretKey('zanoTestWalletReceiveAddress', () => ''),
    SecretKey('decredTestWalletReceiveAddress', () => ''),
    SecretKey('dogeTestWalletReceiveAddress', () => ''),
    SecretKey('zcashTestWalletReceiveAddress', () => ''),
