...
class DecredBalance extends Balance {
  ...
  factory DecredBalance.zero() => DecredBalance(confirmed: Money.zero(CryptoCurrency.dcr), unconfirmed: Money.zero(CryptoCurrency.dcr), frozen: Money.zero(CryptoCurrency.dcr));
}
