...
class ArbitrumTransactionInfo extends EVMChainTransactionInfo {
  ArbitrumTransactionInfo({
    required super.id,
  ...
  factory ArbitrumTransactionInfo.fromJson(Map<String, dynamic> data) {
    return ArbitrumTransactionInfo(
