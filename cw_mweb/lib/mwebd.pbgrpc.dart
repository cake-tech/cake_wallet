...
class RpcClient extends $grpc.Client {
  ...
  static final _$psbtAddRecipient = $grpc.ClientMethod<$0.PsbtAddRecipientRequest, $0.PsbtResponse>(
      ...
      ($core.List<$core.int> value) => $0.PsbtResponse.fromBuffer(value));
  static final _$psbtGetRecipients =
      $grpc.ClientMethod<$0.PsbtGetRecipientsRequest, $0.PsbtGetRecipientsResponse>(
  ...
  $grpc.ResponseFuture<$0.PsbtResponse> psbtAddInput($0.PsbtAddInputRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$psbtAddInput, request, options: options);
  }

  $grpc.ResponseFuture<$0.PsbtResponse> psbtAddRecipient($0.PsbtAddRecipientRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.PsbtResponse> psbtSignNonMweb($0.PsbtSignNonMwebRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$psbtSignNonMweb, request, options: options);
  }

  $grpc.ResponseFuture<$0.CreateResponse> psbtExtract($0.PsbtExtractRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.BroadcastResponse> broadcast($0.BroadcastRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class RpcServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.PsbtResponse> psbtCreate_Pre(
      $grpc.ServiceCall call, $async.Future<$0.PsbtCreateRequest> request) async {
    return psbtCreate(call, await request);
  }

  $async.Future<$0.PsbtResponse> psbtAddInput_Pre(
      $grpc.ServiceCall call, $async.Future<$0.PsbtAddInputRequest> request) async {
    return psbtAddInput(call, await request);
  }

  $async.Future<$0.PsbtResponse> psbtAddRecipient_Pre(
      $grpc.ServiceCall call, $async.Future<$0.PsbtAddRecipientRequest> request) async {
    return psbtAddRecipient(call, await request);
  }

  $async.Future<$0.PsbtGetRecipientsResponse> psbtGetRecipients_Pre(
      $grpc.ServiceCall call, $async.Future<$0.PsbtGetRecipientsRequest> request) async {
  ...
  $async.Future<$0.PsbtResponse> psbtSignNonMweb_Pre(
      $grpc.ServiceCall call, $async.Future<$0.PsbtSignNonMwebRequest> request) async {
    return psbtSignNonMweb(call, await request);
  }

  $async.Future<$0.CreateResponse> psbtExtract_Pre(
      $grpc.ServiceCall call, $async.Future<$0.PsbtExtractRequest> request) async {
  ...
  $async.Future<$0.BroadcastResponse> broadcast_Pre(
      $grpc.ServiceCall call, $async.Future<$0.BroadcastRequest> request) async {
